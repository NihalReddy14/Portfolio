...
console.log('%c Welcome to Nihal Reddy\'s Portfolio! 🚀', 'color: #2563eb; font-size: 20px; font-weight: bold;');
console.log('%c Built with ❤️ using HTML, CSS, and JavaScript', 'color: #6b7280; font-size: 14px;');